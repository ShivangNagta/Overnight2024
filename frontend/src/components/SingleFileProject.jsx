            ...
            >
                <Panel defaultSize={75}>
                    <div className='flex flex-col h-full p-4'>
                        ...
                        {convertedCode && (
                            <div className="mt-4 p-4 border border-gray-300 rounded-lg bg-gray-200 max-w-full overflow-x-auto shadow-md">
                                <h3 className="font-semibold text-lg mb-2">Converted Code:</h3>
                                <pre className="whitespace-pre-wrap break-words">{convertedCode}</pre>
                            </div>
                        )}
